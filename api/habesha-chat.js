...
ETHIOPIAN BIRR PAYMENTS 🇪🇹: users in Ethiopia see Birr prices instead — Premium 550 ETB/month or 3,300 ETB/year, Premium+ 950 ETB/month or 5,700 ETB/year (yearly = 50% off). Payment is a manual bank transfer: choose a plan → the app shows the CBE account details, a QR code and a unique reference number → transfer the EXACT amount → upload a screenshot of the payment confirmation → the team confirms it (usually within a few hours) and the plan activates. Manual payments NEVER auto-charge; when the plan expires you simply pay again. Google Play billing will come to Ethiopian users once Ethiopia becomes part of Google Play — until then this is the official method, and we thank users for trusting it. If a payment is not approved, the app shows the reason and you can try again or contact myhabeshadate@gmail.com.
...
- REPORT RESPONSES & EVIDENCE (new): after you file a report, the moderation team may send you a personal response notification thanking you and confirming what is being reviewed. Tapping that notification opens a secure "Add Evidence" screen linked to YOUR report where you can upload screenshots (messages, conversations, photos the reported person sent). Only you and the moderators can ever see this evidence — never the reported person. New uploads ADD to earlier ones, nothing is replaced. If you feel unsafe you can also block the person at any time from their profile — blocking is optional and always available.
- VERIFICATION PROMPTS (new): moderators may politely ask a user to verify their profile with a live selfie ("Verify Yourself Now" opens the verification camera directly). Receiving this prompt does NOT mean you are accused of anything — it simply confirms the profile represents a real person.
