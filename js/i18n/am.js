...
export default {
  ...
  divisions: {
    ...
    engine_spec_1_title: 'ቪዲዮ ዳሳቶች',
    engine_spec_1_sub: 'HD የምህንድስና ይዘቶች',
    engine_spec_2_title: 'መሥርት አባላት',
    engine_spec_2_sub: 'ነፃ ማውረዶች',
    engine_cta: 'ዩቱብ ቻናልን ጎብኙ',
    fithub_spec_1_title: '6+ ፕሮግራሞች',
    fithub_spec_1_sub: 'በቅርቡ ይጀምራል',
    fithub_spec_2_title: 'ነፃ ይዘቶች',
    fithub_spec_2_sub: 'ሁሉም ፕሌትፎርሞች',
