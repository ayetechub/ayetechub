...
export default {
  ...
  faq: {
    ...
    q2: 'AYE Tech Hub የትኞቹን የምህንድስና ርዕሶች ይሸፍናል?',
    a2: 'AYE Tech Hub PLC ፕሮግራሚንግ፣ ኢንዱስትሪያል ኦቶሜሽን፣ ኤሌክትሪካዊ ምህንድስና፣ ሜካኒካዊ ምህንድስና፣ Revit እና CAD፣ AI ለምህንዶሶች፣ ፀሐይ እና HVAC፣ ሮቦቲክስ እና ጥገናን ይሸፍናል — ነፃ ዩቱብ ዳሳቶች እና ፕሪሚዬም ኮርሶችን ጨምሮ።',
  ...
  footer: {
    tagline: 'ለዓለም አቀፍ ምህንዶሶች ፕሪሚዬም የምህንድስና ትምህርት መድረክ — AYE Tech Hub።',
    ...
    copyright: '© 2026 AYE Tech Hub. ሁሉም መብቶቸ ተጠብቀዋሉ።'
  }
};
